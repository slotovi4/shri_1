...
exports.HeaderComponent = exports.FooterComponent = exports.CanvVideoBlockComponent = void 0;

var _classname = require("@bem-react/classname");

var _core = require("@bem-react/core");
...
var CanvVideoBlockComponent = (0, _core.withBemMod)(cnCanvVideoBlock(), {
  app: "common"
})(CanvVideoBlock);
exports.CanvVideoBlockComponent = CanvVideoBlockComponent;
...
var FooterComponent = (0, _core.withBemMod)(cnFooter(), {
  app: "common"
})(Footer);
...
var HeaderComponent = (0, _core.withBemMod)(cnHeader(), {
  app: "common"
})(Header);
exports.HeaderComponent = HeaderComponent;

},{"@bem-react/classname":5,"@bem-react/core":8}],2:[function(require,module,exports){
"use strict";

var _classname = require("@bem-react/classname");

var _di = require("@bem-react/di");

var _reactComponents = require("./reactComponents");

var cnApp = (0, _classname.cn)('App');
var cnHeader = (0, _classname.cn)('Header');
var cnFooter = (0, _classname.cn)('Footer');
var cnCanvVideoBlock = (0, _classname.cn)('CanvVideoBlock');
var registry = new _di.Registry({
  id: cnApp()
});
registry.set(cnHeader(), _reactComponents.HeaderComponent);
registry.set(cnFooter(), _reactComponents.FooterComponent);
registry.set(cnCanvVideoBlock(), _reactComponents.CanvVideoBlockComponent);

var HeaderElem = function HeaderElem() {
  return React.createElement(_di.RegistryConsumer, null, function (registries) {
    // reading App registry
    var registry = registries[cnApp()];
    var HeaderNew = registry.get(cnHeader());
    return React.createElement(HeaderNew, null);
  });
};

var FooterElem = function FooterElem() {
  return React.createElement(_di.RegistryConsumer, null, function (registries) {
    var registry = registries[cnApp()];
    var FooterNew = registry.get(cnFooter());
    return React.createElement(FooterNew, null);
  });
};

var VideoElem = function VideoElem() {
  return React.createElement(_di.RegistryConsumer, null, function (registries) {
    var registry = registries[cnApp()];
    var VideoNew = registry.get(cnCanvVideoBlock());
    var videos = getData('/dist/data/videos.json');
    return React.createElement(VideoNew, {
      videos: videos
    });
  });
};

var HeaderApp = (0, _di.withRegistry)(registry)(HeaderElem);
var FooterApp = (0, _di.withRegistry)(registry)(FooterElem);
var VideoApp = (0, _di.withRegistry)(registry)(VideoElem);
/* Render */

ReactDOM.render(React.createElement(HeaderApp, null), document.querySelector('header'));
ReactDOM.render(React.createElement(FooterApp, null), document.querySelector('footer'));
ReactDOM.render(React.createElement(VideoApp, null), document.querySelector('.Container'));
/* Get Json */
...
},{"./reactComponents":1,"@bem-react/classname":5,"@bem-react/di":12}],3:[function(require,module,exports){
'use strict';
...
},{"@bem/sdk.naming.entity.stringify":13}],4:[function(require,module,exports){
...
},{"@bem/sdk.naming.entity.stringify":13}],5:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./build/cjs/classname.development.js":3,"./build/cjs/classname.production.min.js":4,"_process":15}],6:[function(require,module,exports){
'use strict';
...
function withBemMod(blockName, mod, cb) {
    return function WithBemMod(WrappedComponent) {
        function BemMod(props) {
            var entity = classname.cn(blockName);
            if (Object.keys(mod).every(function (key) { return props[key] === mod[key]; })) {
                var nextClassName = classname.classnames(entity(mod), props.className);
                ...
                return cb
                    ...
                    : React.createElement(WrappedComponent, __assign({}, nextProps));
            }
            {
                setDisplayName(BemMod, {
                    wrapper: WithBemMod,
...
exports.withBemMod = withBemMod;
exports.compose = compose;

},{"@bem-react/classname":5,"object-assign":9,"react":20}],7:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _assign=require("object-assign"),React=require("react"),classname=require("@bem-react/classname"),__assign=function(){return(__assign=_assign||function(e){for(var r,n=1,t=arguments.length;n<t;n++)for(var s in r=arguments[n])Object.prototype.hasOwnProperty.call(r,s)&&(e[s]=r[s]);return e}).apply(this,arguments)};function withBemMod(a,c,o){return function(s){return function(r){var e=classname.cn(a);if(Object.keys(c).every(function(e){return r[e]===c[e]})){var n=classname.classnames(e(c),r.className),t=Object.assign({},r,{className:n});return o?o(s,t):React.createElement(s,__assign({},t))}return React.createElement(s,__assign({},r))}}}function compose(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];return e.reduce(function(n,t){return function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];return n(t.apply(void 0,e))}},function(e){return e})}exports.withBemMod=withBemMod,exports.compose=compose;

},{"@bem-react/classname":5,"object-assign":9,"react":20}],8:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./build/cjs/core.development.js":6,"./build/cjs/core.production.min.js":7,"_process":15}],9:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"object-assign":14,"react":20}],11:[function(require,module,exports){
...
},{"object-assign":14,"react":20}],12:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./build/cjs/di.development.js":10,"./build/cjs/di.production.min.js":11,"_process":15}],13:[function(require,module,exports){
'use strict';
...
},{"_process":15,"object-assign":21,"prop-types/checkPropTypes":16}],19:[function(require,module,exports){
/** @license React v16.6.1
...
},{"object-assign":21}],20:[function(require,module,exports){
(function (process){
'use strict';
